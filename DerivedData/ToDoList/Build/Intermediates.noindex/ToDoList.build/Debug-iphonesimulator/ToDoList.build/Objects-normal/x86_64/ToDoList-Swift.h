...
SWIFT_CLASS("_TtC8ToDoList22AddGroupViewController")
...
- (IBAction)cancel;
- (IBAction)done;
- (IBAction)textFieldDidChange:(UITextField * _Nonnull)sender;
...
SWIFT_CLASS("_TtC8ToDoList21AddItemViewController")
...
- (IBAction)cancel;
- (IBAction)done;
- (IBAction)texfieldDidChange:(UITextField * _Nonnull)sender;
...
SWIFT_CLASS("_TtC8ToDoList13ChecklistItem")
...
SWIFT_CLASS("_TtC8ToDoList23ChecklistViewController")
...
SWIFT_CLASS("_TtC8ToDoList9GroupItem")
...
SWIFT_CLASS("_TtC8ToDoList24GroupTableViewController")
@interface GroupTableViewController : UITableViewController <UINavigationControllerDelegate>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8ToDoList24IconPickerViewController")
